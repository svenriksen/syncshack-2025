...
# Mock Database Script for SyncShack 2025
# This script injects realistic test data into the database

set -e

echo "🌱 Starting mock database injection..."
...
# Create a Node.js script to inject the data
cat > inject-test-data.js << 'EOF'
...
echo "🚀 Running test data injection..."
node inject-test-data.js

echo "🧹 Cleaning up..."
rm inject-test-data.js

echo "🎉 Mock database setup complete!"
echo ""
echo "📋 Summary of injected data:"
echo "   • 10 test users with profiles"
echo "   • 50-250 trips across 8 regions"
echo "   • Gardens with various tree types"
echo "   • 5 weeks of leaderboard data"
echo "   • Realistic trip validation and audit flags"
echo ""
echo "🌐 You can now test the 'Everyone's Impact' feature with real data!"
echo "   Visit: http://localhost:3000/impact/everyone"
