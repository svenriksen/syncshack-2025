          ...
          <header className="border-b border-white/10 bg-black/10 backdrop-blur supports-[backdrop-filter]:bg-black/20">
            <div className="container-slim flex items-center justify-between py-3">
              ...
              <nav className="flex items-center gap-3 text-sm text-white/80">
                <a className="hover:text-white" href="/trip">Trip</a>
                <a className="hover:text-white" href="/garden">Garden</a>
                <a className="hover:text-white" href="/leaderboard">Leaderboard</a>
                <a className="hover:text-white" href="/impact">Impact</a>
                <a className="ml-2 rounded-[var(--radius-sm)] bg-[rgb(var(--color-primary))] px-3 py-1.5 text-black hover:bg-[rgb(var(--color-primary-600))] hover:text-white" href="/auth">Sign in</a>
              </nav>
            </div>
          </header>
