    ...
    <form onSubmit={onSubmit} className="space-y-4">
      <div>
        ...
        <input
          ...
          className="w-full rounded-[var(--radius-sm)] border border-white/10 bg-white/5 px-3 py-2 outline-none placeholder:text-white/40 focus:border-white/20"
      ...
      <div>
        ...
        <textarea
          ...
          className="w-full min-h-24 rounded-[var(--radius-sm)] border border-white/10 bg-white/5 px-3 py-2 outline-none placeholder:text-white/40 focus:border-white/20"
      ...
      <div>
        ...
        <div className="flex gap-2">
          <div ref={dropdownRef} className="relative w-full">
            <button
              type="button"
              onClick={() => setOpen((v) => !v)}
              className="flex w-full items-center justify-between rounded-[var(--radius-sm)] border border-white/10 bg-white/10 px-3 py-2 text-left text-white outline-none transition hover:bg-white/15 focus:border-white/20"
            >
              <span className={location ? "" : "text-white/50"}>
            ...
            {open && (
              <div className="absolute z-50 mt-1 max-h-72 w-full overflow-auto rounded-[var(--radius-sm)] border border-white/10 bg-black/90 p-1 shadow-[var(--shadow-lg)] backdrop-blur">
                {detectedLocation && (
                  <div
                    role="option"
                    tabIndex={0}
                    ...
                    className="cursor-pointer rounded px-2 py-2 text-sm text-white hover:bg-white/10"
                  >
        ...
        <p className="mt-1 text-xs text-white/50">Choose a suggested location or use Detect. Custom entries are disabled.</p>
      </div>
