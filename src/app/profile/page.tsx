...
export default async function ProfilePage() {
  ...
  return (
    <div className="flex min-h-[85svh] flex-col gap-6">
      {/* Hero */}
      <section className="relative overflow-hidden rounded-[var(--radius-lg)] bg-gradient-to-b from-white/10 to-white/5">
        ...
        <div className="p-6 md:px-8 md:py-7">
          <div className="flex flex-col gap-5 md:flex-row md:items-end md:justify-between">
            <div className="flex items-start gap-4">
              <div className="relative h-20 w-20 shrink-0 rounded-full border border-white/15 bg-white/5 p-1 shadow-[var(--shadow-md)] md:h-24 md:w-24">
              ...
              <div>
                ...
                <p className="mt-2 max-w-prose text-sm text-white/80">{user.bio}</p>
                <div className="mt-3 flex flex-wrap items-center gap-3 text-xs text-white/60">
                  <span className="inline-flex items-center gap-1 rounded-[var(--radius-sm)] bg-white/5 px-2 py-1">
      ...
      <section className="grid grid-cols-1 gap-4 md:grid-cols-3">
        ...
        <div className="card p-5">
          ...
          <dl className="grid grid-cols-3 gap-x-3 gap-y-2 text-sm text-white/80">
            <dt className="col-span-1 text-white/60">Username</dt>
            <dd className="col-span-2">{user.username}</dd>
            <dt className="col-span-1 text-white/60">Location</dt>
            <dd className="col-span-2">{user.location}</dd>
            <dt className="col-span-1 text-white/60">Joined</dt>
